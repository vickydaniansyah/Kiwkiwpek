...
class OrderKuota {
    ...
    // LIST INDO IP buat X-Forwarded-For
    static INDO_IPS = [
        '114.4.83.42', '114.4.83.43', '114.4.83.44',
        '36.66.192.1', '36.66.192.2', '36.66.192.3',
        '125.162.107.50', '125.162.107.51',
        '180.250.135.18', '180.250.135.19',
        '103.119.108.6', '103.119.108.7',
        '182.253.2.34', '182.253.2.35'
    ];
    ...
    buildHeaders() {
        return {
            ...
            'X-Forwarded-For': OrderKuota.INDO_IPS[Math.floor(Math.random() * OrderKuota.INDO_IPS.length)],
            'X-Real-IP': OrderKuota.INDO_IPS[Math.floor(Math.random() * OrderKuota.INDO_IPS.length)]
        };
    }
    ...
    async request(method, url, body = null) {
        try {
            ...
            return { 
                error: err.message,
                success: false,
                message: "Network error, coba lagi"
            };
        }
    }
